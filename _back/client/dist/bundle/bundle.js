...
var serverHost = "http://127.0.0.1:9000";

var server = exports.server = crossDomain ? serverHost : window.location.origin;

var ajaxCrossDomainSettings = exports.ajaxCrossDomainSettings = crossDomain ? { xhrFields: { withCredentials: true }, crossDomain: true } : {};
...
var _lowdb = __webpack_require__(28);
...
var setCookie = function setCookie(key, val) {
  var exp = new Date();
...
var emitFileSocketStart = function emitFileSocketStart(data) {
  _index2.default.emit("fileStart", data, function (ack) {
    console.log(ack);
  });
};

var emitFileSocketProgress = function emitFileSocketProgress(data) {
  _index2.default.emit("fileProgress", data, function (ack) {
    console.log(ack);
  });
};

var emitFileSocketDone = function emitFileSocketDone(data) {
  _index2.default.emit("fileDone", data, function (ack) {
    console.log(ack);
  });
};
...
var source = "{{each data val}}" + "<div class=\"chats-win-history-item\" data-isMine={{val.isMine}} data-hid={{val.id}}>" + "<div class=\"inner-history-item\">" + "<div class=\"history-item-info\">" + "<div class=\"history-item-info-message\">{{@ val.message}}</div>" + "<div class=\"history-item-info-time\">{{val.time}}</div>" + "</div>" + "<img src={{val.avater}} class=\"history-item-avater\">" + "</div>" + "</div>" + "{{/each}}";
...
var _emit = __webpack_require__(6);

var _item = __webpack_require__(42);

var _item2 = _interopRequireDefault(_item);

var _item3 = __webpack_require__(43);
...
var _historyItem = __webpack_require__(8);
...
socket.on("recMessages", function (data) {
  ...
  if (_db2.default.get('histories').find({ username: data.sender.username }).value()) {
    ...
    //如果历史记录超过100条则去掉第一条
    if (chatsWithHis.size().value() > _utils.hisLimit) {
...
(0, _page2.default)("/register", function () {
...
var _chatsWin = __webpack_require__(25);
...
window.locals = {
  ...
  set mine(data) {
    ...
    this._mine = data;
    var avater = _config.server + "/" + data.avater;
...
var lodash = __webpack_require__(29);
...
var loginEvent = function loginEvent(loginBtn) {
  var isLogin = (0, _cookie.getCookie)("isLogin");
  if (isLogin === "true") _page2.default.redirect("/home");
  (0, _jquery2.default)(document).on("click", loginBtn, function () {
    onLoginBtn();
  });
  (0, _jquery2.default)(document).on("keydown", ".login-container", function (e) {
    if (e.keyCode === 13) {
      onLoginBtn();
    }
  });
...
var loginAjax = function loginAjax(data) {
  var options = Object.assign({
    type: "post",
    dataType: "json",
    url: _config.server + "/server/login",
    data: data
  }, _config.ajaxCrossDomainSettings);
...
var _left = __webpack_require__(47);

var _left2 = _interopRequireDefault(_left);

var _middle = __webpack_require__(58);

var _middle2 = _interopRequireDefault(_middle);

var _right = __webpack_require__(71);
...
var _chat = __webpack_require__(50);
...
var source = "<li class='left'>" + "<div class=\"mine\"><img src=''></div>" + "<ul class=\"menu-group\">" + "{{each menus val i}}" + "<li class='menu-item' data-type={{val.type}} title={{val.title}}>{{@ val.icon}}</li>" + "{{/each}}" + "</ul>" + "<div class='bottom-btns-group'>" + "<div title='退出' class=\"logout-btn\">" + _logout2.default + "</div>" + "<div title='设置' class=\"setting-btn\">" + _setting2.default + "</div>" + "</div>" + "</li>";
...
var logoutSvg = "<svg version=\"1.1\" xmlns=\"http://www.w3.org/2000/svg\" xmlns:xlink=\"http://www.w3.org/1999/xlink\" x=\"0px\" y=\"0px\" viewBox=\"0 0 1000 1000\" enable-background=\"new 0 0 1000 1000\" xml:space=\"preserve\"><g><path d=\"M524.5,10h-49v441.2h49V10L524.5,10z M688.1,89.7V133c141.3,70.3,238.7,217.2,238.7,386.7c0,237.7-191.5,431.1-426.8,431.1c-235.4,0-426.9-193.4-426.9-431.1c0-164.8,92.1-308.1,227-380.7V95C142.9,170.6,34.3,332.3,34.3,519.7C34.3,779.5,242.8,990,500,990c257.2,0,465.7-210.5,465.7-470.3C965.7,327.7,851.6,162.6,688.1,89.7z\"/></g></svg>";
...
var _settingAlert = __webpack_require__(56);
...
var leftEvent = function leftEvent() {
  ...
  $(document).on("click", ".logout-btn", function () {
    (0, _sweetalert2.default)({
      ...
      if (val) (0, _logout2.default)();
    });
  });
  //设置
  $(document).on("click", ".setting-btn", function () {
    (0, _settingAlert2.default)();
  });
};
...
var logoutAjax = function logoutAjax() {
  var options = Object.assign({
    type: "post",
    dataType: "json",
    url: _config.server + "/server/logout"
  }, _config.ajaxCrossDomainSettings);
  $.ajax(options);
  (0, _emit.emitLogoutSocket)();
  (0, _cookie.setCookie)("isLogin", false);
  page.redirect("/login");
};
...
var _chats = __webpack_require__(67);

var _chats2 = _interopRequireDefault(_chats);

var _rooms = __webpack_require__(68);
...
var source = "<li class=\"chats-group active\">" + "<div class=\"chats-none\">暂无消息</div>" + "</li>";
...
var _chatsInputBox = __webpack_require__(73);
...
var _chatsInputTools = __webpack_require__(76);
...
var chatsInputEvent = function chatsInputEvent() {
  $(document).on("click", ".chats-input-btn", function () {
    ...
    var message = inputCont.html().replace(/<div><br><\/div>/ig, '');
    if (!message || message.length === 0) {
      return;
    }
    var chatsWin = $(".chats-win-history-group");
    var now = moment().format("MM-DD HH:mm");
    var id = (0, _utils.createId)();
    var data = [{ isMine: "true", message: message, time: now, avater: _config.server + "/" + window.locals.mine.avater, id: id }];
...
var _torrent = __webpack_require__(83);
...
var chatsInputToolsEvent = function chatsInputToolsEvent() {
    $('#fileupload').fileupload({
        url: _config.server + '/server/upload',
        dataType: 'json',
        autoUpload: false,
        ...
        if (data.result.status) {
            ...
            if (/image\/\w+/.test(file.type)) {
                isImg = true;
                fileMess.children("img").attr('src', _config.server + '/file/' + data.result.url);
                data.html.children("img").attr('src', _config.server + '/file/' + data.result.url);
            }
...
var _unloadAlert = __webpack_require__(86);
...
var unloadAlert = function unloadAlert() {
...
var _loading = __webpack_require__(95);
...
var _avaterCropper = __webpack_require__(90);
...
var _validate = __webpack_require__(92);
...
var _dataURLtoBlob = __webpack_require__(94);
...
var registerAjax = function registerAjax() {
  ...
  var imgBlob = (0, _dataURLtoBlob2.default)($(".register-avater").attr("src"));
  data.append("avater", imgBlob);
  var options = Object.assign({
    type: "post",
    dataType: "json",
    url: _config.server + "/server/register",
    contentType: false,
    processData: false,
    data: data
  }, _config.ajaxCrossDomainSettings);
