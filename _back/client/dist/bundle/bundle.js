...
socket.on("recFileDone", function (data) {
  ...
  _db2.default.get('histories').find({ time: data.uploadTime }).assign({ lastMess: message }).write();
  _db2.default.get('chatsWith').find({ username: data.receiver }).get("histories").find({ time: data.uploadTime }).assign({ message: message }).write();
});
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(9), __webpack_require__(29)(module)))
...
var chatsInputToolsEvent = function chatsInputToolsEvent() {
    ...
    function renderFileMess(data) {
        ...
        var file = data.files[0];
        var id = '' + file.lastModified + file.size + new Date().getTime() + Math.floor(Math.random() * 1000);
        data.contextId = id;
...
var _unloadAlert = __webpack_require__(85);
...
var _avaterCropper = __webpack_require__(89);
...
var _validate = __webpack_require__(91);
...
var _dataURLtoBlob = __webpack_require__(93);
