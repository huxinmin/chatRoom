...
var _anime = __webpack_require__(4);
...
var _item3 = __webpack_require__(7);
...
var _chatsWith = __webpack_require__(11);

var _item5 = __webpack_require__(12);
...
var _historyItem = __webpack_require__(10);
...
var _logout = __webpack_require__(103);

var _logout2 = _interopRequireDefault(_logout);

var _settingAlert = __webpack_require__(104);
...
var renderChats = function renderChats(tabs) {
	...
	function getChatsRenderChats(itemName, typename, assignData) {
		localforage.getItem(itemName).then(function (chats, err) {
			chats = chats || [];
...
var chatsInputEvent = function chatsInputEvent() {
	(0, _jquery2.default)(document).on("click", ".chats-input-btn", function () {
		...
		var data = [{ isMine: "true", message: message, time: now, avater: window.locals.mine.avater }];
...
var _unloadAlert = __webpack_require__(102);
...
var _addInChatsPro = __webpack_require__(71);
...
var _avaterCropper = __webpack_require__(75);
...
var _validate = __webpack_require__(77);
...
var _dataURLtoBlob = __webpack_require__(79);
